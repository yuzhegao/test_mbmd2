...
from data_utils import crop_search_region,draw_box
...
class vid_dataset(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        template,img = Image.open(self.img_root + template_file),\
                       Image.open(self.img_root + img_file)
        ...
        search_region, win_loc, scaled = crop_search_region(img, img_gt, self.img_size,offset=[offset_y,offset_x])
